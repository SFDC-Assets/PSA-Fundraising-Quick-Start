...
**Last updated:** 2026-07-26 (Gift Follow-Up / Stewardship redesign shipped, then ack flow renamed back to FQS_Gift_Acknowledgement for package cleanliness: universal-rule ack + tier-matrixed stewardship, stewardship + tax-receipt fields, stewardship queue + template)
