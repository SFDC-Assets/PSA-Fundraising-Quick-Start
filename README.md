...
* An **unmanaged package** (link below; metadata is also found in the [/force-app/main/default/](/force-app/main/default/) folder) that includes:
    * Apex classes (x2)
    * Custom objects (x4)
    * Lightning Web Components (LWCs) (x2)
* **OmniScripts** (x2) located in the /datapacks/ folder
* **Documentation**, including:
    * This readme file
    * White paper providing detailed setup instructions and a data dictionary (located in the [/docs/](/docs/) folder)
